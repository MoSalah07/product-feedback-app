...
import classes from "../../buttons/ButtonList.module.css";
...
function Nav({ setGetValSortBy, getValSortBy, data, refSpanInNav }) {
  const [toggleList, setToggleList] = useState(false); // dependency Function [1]
  const { items } = useSelector((state) => state.product);
  const [counterSuggestions, setCounterSuggestions] = useState(data.length);
  // Function Toggle [1]
  const ChangeToggleList = () => setToggleList(!toggleList);

  // console.log(counterSuggestions)
  // console.log(items)
  // function getValListSelect [2]
  const getValuesBtns = (e) =>
    setGetValSortBy(
  ...
  return (
    <nav className={styles.nav}>
      <div>
        ...
        <div onClick={ChangeToggleList}>
          <label htmlFor="select">sort by:</label>
          <div>
            <span>{getValSortBy || "most upvotes"}</span>
          ...
          {toggleList && (
            <ul id="select">
              <li onClick={getValuesBtns} className={classes.buttonList}>
                <ButtonList value="most-upvotes">most upvotes</ButtonList>
              ...
              <li onClick={getValuesBtns} className={classes.buttonList}>
                <ButtonList value="least-upvotes">least upvotes</ButtonList>
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="11">
                  <path
                    fill="none"
                    stroke="#AD1FEA"
              ...
              <li onClick={getValuesBtns} className={classes.buttonList}>
                <ButtonList value="most-comments">most comments</ButtonList>
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="11">
                  <path
                    fill="none"
                    stroke="#AD1FEA"
              ...
              <li onClick={getValuesBtns} className={classes.buttonList}>
                <ButtonList value="least-comments">least comments</ButtonList>
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="11">
                  <path
                    fill="none"
                    stroke="#AD1FEA"
